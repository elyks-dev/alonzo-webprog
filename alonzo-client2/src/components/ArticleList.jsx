  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
        <div className="flex aspect-4/3 items-center justify-center rounded-[1.25rem] overflow-hidden bg-zinc-200">
          <img
            src="https://images.unsplash.com/photo-1594322436404-5a0526db4d13?w=600&auto=format&fit=crop"
            alt="404 Test"
            className="w-full h-full object-cover"
          />
        </div>
        ...
        <h3 className="mt-2 text-lg font-semibold text-zinc-900">Page Not Found Test</h3>
        <p className="mt-3 text-sm leading-6 text-zinc-600">
          Click Read More to test the 404 Not Found page...
        </p>
        <Link to="/this-does-not-exist">
          <Button className="mt-4">Read More</Button>
        </Link>
      </article>
